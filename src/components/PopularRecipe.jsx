                        ...
                        return (
                            <div className="group space-y-3 text-center bg-white/50 shadow-md p-3 rounded-xl">
                                <img
                                    src={item.img}
                                    alt=""
                                    className="w-44 mx-auto img-shadow group-hover:scale-110 group-hover:translate-y-[-50px] group-hover:translate-x-10 group-hover:rotate-[50deg] transition-all duration-500"
                                />
                                <div>
